...
export const CourseView = ({ rest, course, fullCourseContent, courseContent, nextContent, contentType }: { fullCourseContent: Folder[], rest: string[], course: any, courseContent: any, nextContent: any, contentType: any }) => {
  return <div>
    <div className="flex">
      ...
      <div className="grow flex justify-center">
        <div className="p-2">
          ...
          {contentType === "folder" ? <FolderView rest={rest} courseContent={courseContent.map((x: any) => ({
            title: x?.title || "",
            image: x?.thumbnail || "",
            id: x?.id || 0
          }))}
